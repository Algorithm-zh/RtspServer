...
public:
  ...
  bool addSink(MediaSession::TrackId trackId, Sink *sink); // Ìí¼ÓÊý¾ÝÉú²úÕß

  bool addRtpInstance(MediaSession::TrackId trackId,
                      RtpInstance *rtpInstance);    // Ìí¼ÓÊý¾ÝÏû·ÑÕß
  bool removeRtpInstance(RtpInstance *rtpInstance); // É¾³ýÊý¾ÝÏû·ÑÕß
...
private:
  ...
  static void sendPacketCallback(void *arg1, void *arg2, void *packet,
